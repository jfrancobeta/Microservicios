...
public class SecurityConfig {
	...
	public RegisteredClientRepository registeredClientRepository() {
		RegisteredClient oidcClient = RegisteredClient.withId(UUID.randomUUID().toString())
				...
				.redirectUri("http://gateway-server:8091/login/oauth2/code/client-app")//el finlal tiene que ser igual al cliente id
				.redirectUri("http://gateway-server:8091/authorized")
				.postLogoutRedirectUri("http://gateway-server:8091/logout")//ruta default de salida o log out
				.scope("read")
				.scope("write")
