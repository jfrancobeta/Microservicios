package com.jfranco.springboot.oauth.springboot_servicio_oauth.security;
...
import com.jfranco.springboot.oauth.springboot_servicio_oauth.services.UsuarioService;
...
public class SecurityConfig {
	...
	public RegisteredClientRepository registeredClientRepository() {
		RegisteredClient oidcClient = RegisteredClient.withId(UUID.randomUUID().toString())
				...
				.redirectUri("http://127.0.0.1:8091/login/oauth2/code/client-app")//el finlal tiene que ser igual al cliente id
				.redirectUri("http://127.0.0.1:8091/authorized")
				.postLogoutRedirectUri("http://127.0.0.1:8091/logout")//ruta default de salida o log out
				.scope("read")
				.scope("write")
